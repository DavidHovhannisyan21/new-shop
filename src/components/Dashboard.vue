...
<v-container fluid>
    ...
    <v-card tile class="mx-16 mt-n10 card1" color="white">
      <v-row>
        <v-col cols="12" sm="8" class="pr-0">
          <v-card height="250px" tile flat color="#61907d">
            <v-row>
              <v-col cols="12" sm="4" class="pl-8 pt-5">
                <v-btn color="black" dark class="withoutupercase" small tile>
                  new
                </v-btn>
                <h6 class="white--text mt-8">ONLY BEST PRICES</h6>
                <h3 class="white--text mt-5">Summer Collection is OUT!</h3>
                <v-btn
                  rounded
                  color="#426255"
                  dark
          ...
          <v-card height="250px" tile flat color="#61907d">
            <v-row>
              <v-col cols="12" sm="6" class="pl-8 pt-5">
                ...
                <h6 class="white--text mt-8">WHITE T-SHIRT</h6>
      ...
      <v-row>
        <v-col cols="12" sm="3" class="mt-n6 pr-0">
            <v-toolbar flat outlined>
                <v-toolbar-title><stron>FILTER</stron></v-toolbar-title>
                <v-spacer></v-spacer>
        ...
        <v-col cols="12" sm="3" class="mt-n6 px0">
            <v-toolbar flat outlined>
              ...
              <v-toolbar-text>COUNT OF ITEMS IN YOUR BASKET - {{ countOfItems }} </v-toolbar-text>
              <v-icon>mdi mdi-basket-outline </v-icon>
            </v-toolbar>
        </v-col>
        ...
        <v-col cols="3" class="py-0 pr-0 mt-n3">
          ...
          <v-card flat outlined tile>
            ...
            <v-range-slider color="green" max="40" min="-30"></v-range-slider>
          </v-card>
          <v-card flat outlined tile>
            <v-toolbar flat>
  ...
  <div style="text-align: center; margin: auto;">
    <img src="1.png" alt="">
        <v-toolbat-title>YOUR SELECTED CLOTHE</v-toolbat-title>
        <v-toolbat-text>PRICE - {{ clothe.price }}</v-toolbat-text>
        <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Odio cumque maiores unde totam, esse eius!</p>
        <v-form
    ref="form"
    v-model="valid"
    lazy-validation 
  >
    <v-text-field v-model="cardHolder"
    ...
    <v-text-field v-model="cvv"
      label="ENTER CVV"
    ></v-text-field>
    <v-text-field v-model="expires"
      label="EXPIRES - MONTH/YEAR"
    ></v-text-field>
    <v-checkbox
      v-model="checkbox"
      :rules="[v => !!v || 'You must agree to continue!']"
      label="Are you sure you want to make this purchase"
      required
    ></v-checkbox>
    <v-btn
      :disabled="!valid"
...
export default {
    ...
    sizes: [
      ...
      "46",
        ...
        itemsOfSelect: ['All', 'Sale', 'Low - High', 'High - Low'],
        clothes: [
      {
        class: "pa-0",
        sold: "-20%",
...
.card__part{
  ...
  display: inline-block;
    width: 320px;
    height: 190px;
    background-image: url('https://e7.pngegg.com/pngimages/84/489/png-clipart-rectangle-computer-icons-square-rectangle-blue-angle.png'), linear-gradient(to right bottom, #fd696b, #fa616e, #f65871, #f15075, #ec4879); /*linear-gradient(to right bottom, #fd8369, #fc7870, #f96e78, #f56581, #ee5d8a)*/
